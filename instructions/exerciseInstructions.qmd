...
In this project folder NAME HERE! you will find the following folders and files:
...
Please be aware of data policy and read it [\[here\]](https://ites-fe.ethz.ch/rws/SS/exerciseSolutions.html#sec-policy)!

# GROUP1

## Tasks

The group should answer 4 questions during the exercises (A-D). Questions A-B addressing process-based modeling for Plot1, C-D addressing empirical modeling for Bryophites species using GLMs. You should form four sub-groups of 3-4 people inside the group to address each of the questions.
...
2.  Get start with the exercise [\[click here\]](https://ites-fe.ethz.ch/rws/SS/exerciseSolutions.html#sec-gs)
...
The group should answer 4 questions during the exercises (A-D). Questions A-B addressing Plot 3, C-D addressing empirical modeling for the presence of the Great spotted woodpecker using BRT. You should form four sub-groups of 3-4 people inside the group to address each of the questions.
...
The group should answer 4 questions during the exercises (A-D). Questions A-B addressing Plot 4, C-D addressing empirical modeling for the presence of the Eurasian treecreeper using BRT. You should form four sub-groups of 3-4 people inside the group to address each of the questions.
